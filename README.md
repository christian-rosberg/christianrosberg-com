...
Entries are ordered automatically: `highlight: true` entries first, then ongoing roles, then by end date, then by start date. Certifications sort newest first by `year`.
